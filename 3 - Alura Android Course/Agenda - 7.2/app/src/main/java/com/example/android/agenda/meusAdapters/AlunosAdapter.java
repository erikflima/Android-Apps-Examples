...
public class AlunosAdapter extends BaseAdapter{
    ...
    //Primero metodo que eh chamado pela "ListView" que esta usando um "AlunosAdapter"
    ...
    //Segundo metodo que eh chamado pela "ListView" que esta usando um "AlunosAdapter"
    ...
    public View getView( int position, View convertView, ViewGroup parent) {
        ...
        //Associando os campos do XML
        //Lembrando que esse campo sera exibido apenas no xml para landscape,
        // o que significa que tenho que validar com um 'if' se ele existe ou nao no momento de inflar
        TextView campoEnderecoDoXML  = (TextView) view.findViewById(R.id.item_endereco);

        if ( campoEnderecoDoXML != null)
            {
                campoTelefoneDoXML.setText(aluno.getEndereco());
            }//if
        ...
        //Lembrando que esse campo sera exibido apenas no xml para landscape,
        // o que significa que tenho que validar com um 'if' se ele existe ou nao no momento de inflar
        TextView campoSiteDoXML      = (TextView) view.findViewById(R.id.item_site);

        if ( campoSiteDoXML != null )
        {
            campoSiteDoXML.setText( aluno.getSite() );
        }//if
