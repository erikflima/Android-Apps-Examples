...
import com.example.android.agenda.ConexaoComServidor.EnviaAlunosParaServidor;
...
public class ListaAlunosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Funcao para click simples sobre os subcomponentes da listView que estao na tela
        ...
        //Vincula o "contextMenu" ao objeto "lista alunos" que esta na tela
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        //
        //Mostrar o menu assim que a aplicacao abrir
        return true;
    }



    //Funcoes das opcoes do menu superior direito
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.menu_enviar_notas:
                ...
                //Essa eh a parte em que vou enviar as de todos os alunos para o servidor//
                new EnviaAlunosParaServidor( this ).execute();
            ...
            case R.id.menu_mapa:
                ...
                //Vai para a tela de mapa
                Intent vaiParaMapa = new Intent ( this, MapaActivity.class );
                startActivity( vaiParaMapa );


                Log.v( "MapaFragment","************PASSO 0");
