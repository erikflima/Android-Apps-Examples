...
public class ReadRss extends AsyncTask <Void, Void, Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        //Criando um Adapter que sabe:
        //  - Quandos itens vao ser exibidos como uma lista
        //  - Qual layout cada item vai ter
        //  - Qual o conteudo de cada Viewchild do layout
        MyAdapter adapter = new MyAdapter( context, feedItems );


        //Dizendo qual vai ser o ViewGroup da recyclerView que esta sendo mostrada la na content_main.xml, que esta dentro da activity_main.xml
        recyclerView.setLayoutManager( new LinearLayoutManager( context ) );


        //Editando a aparecencia da recyclerView com instrucoes da classe VerticalSpace que criei
        recyclerView.addItemDecoration( new VerticalSpace(50) );


        //Dizendo qual sera o adapter que vai montar os itens da recycleView que:
